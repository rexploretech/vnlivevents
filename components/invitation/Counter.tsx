...
function Digit({ place, value, height, digitStyle }: DigitProps) {
  ...
  // Decimal point digit - render after hooks
  if (place === '.') {
    return (
      <span
        className="relative inline-flex items-center justify-center transform-gpu"
  ...
  return (
    <span className="relative inline-flex overflow-hidden transform-gpu" style={{ ...defaultStyle, ...digitStyle }}>
...
export default function Counter({
  ...
  return (
    <span style={{ ...defaultContainerStyle, ...containerStyle }}>
      <span style={{ ...defaultCounterStyle, ...counterStyle }} className="font-cinzel shadow-none drop-shadow-none">
        {places.map((place) => (
